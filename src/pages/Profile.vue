<template>
  <div class="container mt-3">
    <div class="row">
      <div class="col-12">
        <div v-if="isMurid" class="card" style="width: 100%;">
          <div class="card-body">
      ...
      <div class="col-12">
        <div v-if="isGuru" class="card" style="width: 100%;">
          <div class="card-body">
            <h4 class="card-title mb-5">Profil Guru</h4>
            <div class="row">
              <div class="col-3">
                <img :src="userInfo.fotoUrl" style="max-width: 200px;" alt="profile image" class="img-thumbnail rounded mb-3">
                <div class="form-group">
            ...
            <form>
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                    <label>NIP</label>
                    <input type="text" class="form-control" disabled v-model="userInfo.nip" placeholder="Nomer Induk Siswa" required>
                  </div>
                </div>
              </div>
              <div class="row">
