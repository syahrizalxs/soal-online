  ...
  <div class="wrapper">
    <nav class="sidebar bg-dark text-light">
      <ul>
        ...
        <li class="list-items pointer" @click="$router.push('/master-mata-pelajaran')" v-if="isAdmin"><b-icon class="h2 m-2 p-1" icon="book"></b-icon><span class="m-2 p-1">Master Mata Pelajaran</span></li>
